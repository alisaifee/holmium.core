...
class HolmiumNose(Plugin):
    ...
    def options(self, parser, env):
        ...
        parser.add_option("", "--holmium-browser", dest="ho_browser", type = "choice", choices = list(holmium.core.config.browser_mapping.keys()), help="the selenium driver to invoke")
        ...
        parser.add_option("", "--holmium-ignore-ssl-errors", action="store_true", dest="ho_ignore_ssl",
    ...
    def configure( self, options, conf ):
        if options.ho_enabled:
            ...
            self.holmium_config = holmium_config = HolmiumConfig(browser, remote_url, caps, user_agent, environment,
                                                                 ignore_ssl)
    ...
    def beforeTest(self, test):
        ...
        try:
            ...
            if config:
                self.config = holmium.core.Config(config, {"holmium":self.holmium_config})
        except Exception as e:
