...
class TestFresherIntegration(PluginTester, unittest.TestCase):
    ...
    def setUp(self):
        ...
        e1 = mock.Mock()
        e1.text = "e"
        ret_val.find_elements.return_value = [e1] * 100
        e1.find_element.return_value.text = "e"
        ret_val.find_element.return_value.find_element.return_value.text = "e"
        ret_val.find_element.return_value.text = "e"
        mock_section_element = mock.Mock()
        mock_section_element.text = "e"
        ret_val.find_element.return_value.find_elements.return_value = [
